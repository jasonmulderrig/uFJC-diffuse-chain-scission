...
# Problem
class NonaffineEightChainModelEqualStrainRateIndependentCavitation(uFJCDiffuseChainScissionProblem):
    ...
    def set_user_parameters(self):
        ...
        x_cavity_surface_point_string = "{:.1f}".format(x_cavity_surface_point)
        y_cavity_surface_point_string = "{:.1f}".format(y_cavity_surface_point)
    ...
    def prefix(self):
        ...
        return mp.macro2micro_deformation_assumption+"_"+mp.micro2macro_homogenization_scheme+"_"+mp.chain_level_load_sharing+"_"+mp.rate_dependence
    ...
    def define_material(self):
        ...
        """
        material = GeneralizeduFJCNetwork(self.parameters)
...
if __name__ == '__main__':
    ...
    problem = NonaffineEightChainModelEqualStrainRateIndependentCavitation(L, H, r_cavity, near_cavity_elem_size, far_cavity_elem_size)
