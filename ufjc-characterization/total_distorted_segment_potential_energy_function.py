...
class TotalDistortedSegmentPotentialEnergyFunctionCharacterizer(uFJCDiffuseChainScissionCharacterizer):
    ...
    def prefix(self):
        return "total_distorted_segment_potential_energy_function"
    ...
    def characterization(self):
        ...
        u_nu_locmin_hat___hat_chunk          = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        overline_u_nu_locmin_hat___hat_chunk = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        lmbda_nu_locmax_hat___hat_chunk      = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        u_nu_locmax_hat___hat_chunk          = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        overline_u_nu_locmax_hat___hat_chunk = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        lmbda_nu___hat_chunk                 = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        u_nu_hat___hat_chunk                 = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        overline_u_nu_hat___hat_chunk        = [0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)]
        ...
        for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num):
            ...
            u_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx]          = u_nu_locmin_hat
            overline_u_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx] = overline_u_nu_locmin_hat
            lmbda_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]      = lmbda_nu_locmax_hat
            u_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]          = u_nu_locmax_hat
            overline_u_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx] = overline_u_nu_locmax_hat
            lmbda_nu___hat_chunk[lmbda_nu_hat_indx]                 = lmbda_nu
            u_nu_hat___hat_chunk[lmbda_nu_hat_indx]                 = u_nu_hat
            overline_u_nu_hat___hat_chunk[lmbda_nu_hat_indx]        = overline_u_nu_hat
        ...
        self.u_nu_locmin_hat___hat_chunk          = u_nu_locmin_hat___hat_chunk
        self.overline_u_nu_locmin_hat___hat_chunk = overline_u_nu_locmin_hat___hat_chunk
        self.lmbda_nu_locmax_hat___hat_chunk      = lmbda_nu_locmax_hat___hat_chunk
        self.u_nu_locmax_hat___hat_chunk          = u_nu_locmax_hat___hat_chunk
        self.overline_u_nu_locmax_hat___hat_chunk = overline_u_nu_locmax_hat___hat_chunk
        self.lmbda_nu___hat_chunk                 = lmbda_nu___hat_chunk
        self.u_nu_hat___hat_chunk                 = u_nu_hat___hat_chunk
        self.overline_u_nu_hat___hat_chunk        = overline_u_nu_hat___hat_chunk
    ...
    def finalization(self):
        ...
        for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num):
            ...
            u_nu_locmin_hat     = self.u_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx]
            lmbda_nu_locmax_hat = self.lmbda_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]
            u_nu_locmax_hat     = self.u_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]
            lmbda_nu            = self.lmbda_nu___hat_chunk[lmbda_nu_hat_indx]
            u_nu_hat            = self.u_nu_hat___hat_chunk[lmbda_nu_hat_indx]
            plt.plot(lmbda_nu, u_nu_hat, linestyle='-', color=cp.color_list[lmbda_nu_hat_indx], alpha=1, linewidth=2.5, label=chain_parameter_label_list[lmbda_nu_hat_indx])
            plt.plot(lmbda_nu_locmin_hat, u_nu_locmin_hat, marker='o', color=cp.color_list[lmbda_nu_hat_indx], alpha=1, linewidth=2.5)
            if lmbda_nu_locmax_hat == np.inf:
                continue
            else:
        ...
        for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num):
            lmbda_nu_locmin_hat      = self.lmbda_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx]
            overline_u_nu_locmin_hat = self.overline_u_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx]
            lmbda_nu_locmax_hat      = self.lmbda_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]
            overline_u_nu_locmax_hat = self.overline_u_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]
            lmbda_nu                 = self.lmbda_nu___hat_chunk[lmbda_nu_hat_indx]
            overline_u_nu_hat        = self.overline_u_nu_hat___hat_chunk[lmbda_nu_hat_indx]
            plt.plot(lmbda_nu, overline_u_nu_hat, linestyle='-', color=cp.color_list[lmbda_nu_hat_indx], alpha=1, linewidth=2.5, label=chain_parameter_label_list[lmbda_nu_hat_indx])
            plt.plot(lmbda_nu_locmin_hat, overline_u_nu_locmin_hat, marker='o', color=cp.color_list[lmbda_nu_hat_indx], alpha=1, linewidth=2.5)
            if lmbda_nu_locmax_hat == np.inf:
                continue
            else:
...
if __name__ == '__main__':
    ...
    characterizer = TotalDistortedSegmentPotentialEnergyFunctionCharacterizer()
