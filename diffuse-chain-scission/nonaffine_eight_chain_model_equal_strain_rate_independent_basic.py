...
# Problem
class NonaffineEightChainModelEqualStrainRateIndependentTest(uFJCDiffuseChainScissionProblem):
    ...
    def set_loading(self):
        ...
        """
        self.fem.u_x_expression.u_x = self.L*self.deformation.u[self.deformation.t_indx]
...
if __name__ == '__main__':
    ...
    L, H, N = 1.0, 1.0, 30
    elem_size = float(L/N)
    problem = NonaffineEightChainModelEqualStrainRateIndependentTest(L, H, elem_size)
